...
default_args = {
  ...
  'mqtt_broker' : '28b92ad3dc2a4b9fac7b8de05498e422.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_GodhelpMe-efe0", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_GodhelpMe-efe0"], schedule=None,catchup=False)
